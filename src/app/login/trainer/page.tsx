            ...
            <div className="relative w-full max-w-xs">
                ...
                <div className="rounded-2xl border p-5 mb-4"
                    ...
                    <div className="flex items-center gap-2.5 mb-5 pb-4 border-b" style={{ borderColor: 'rgba(255,255,255,0.06)' }}>
                        ...
                        <div>
                            ...
                            <p className="text-[10px]" style={{ color: 'rgba(255,255,255,0.35)' }}>Panel de gestión de alumnos</p>
                        </div>
                    </div>
                ...
                <div className="space-y-2 text-center">
                    <p className="text-xs" style={{ color: 'rgba(255,255,255,0.2)' }}>
                        ¿No tenés cuenta?{' '}
                        <a href="/signup/trainer" className="font-bold text-violet-400 hover:text-violet-300 transition-colors">Registrate gratis</a>
                    </p>
                    <p>
