    ...
    return (
        <div className="relative flex min-h-screen flex-col items-center justify-center bg-[#07070a] p-5 text-white overflow-hidden">
            ...
            <div className="pointer-events-none fixed inset-0">
                <div className="absolute top-1/3 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[500px] h-[500px] rounded-full bg-emerald-700/15 blur-[110px] animate-pulse" />
            ...
            <div className="relative w-full max-w-xs">
                ...
                <div className="rounded-2xl border p-5 mb-5"
                    ...
                    <div className="flex items-center gap-2 mb-5 pb-4 border-b"
                        ...
                        <div>
                            ...
                            <p className="text-[10px] text-white/35">Registrá tu entrenamiento de hoy</p>
                        </div>
                    </div>
                ...
                <div className="space-y-2 text-center">
                    <p className="text-xs text-white/20">
                        ¿No tenés cuenta?{' '}
                        <Link href="/signup/student" className="font-bold text-emerald-400 hover:text-emerald-300 transition-colors">
                            Registrate gratis
                        </Link>
                    </p>
                    <p>
